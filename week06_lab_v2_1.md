...
สาเหตุ:
โปรเจกต์ยังไม่ได้ติดตั้ง package http สำหรับเรียกใช้งาน HTTP API

วิธีแก้ไข:
ใช้คำสั่ง flutter pub add http เพื่อติดตั้ง package http

ผลการแก้ไข:
หลังติดตั้งแล้วรัน flutter analyze อีกครั้ง ไม่พบ error ดังกล่าว และสามารถเรียก Fake Store API ได้
...
1. การแปลง JSON
http ต้องใช้ jsonDecode() เพื่อแปลงข้อมูล JSON เอง
ส่วน dio สามารถใช้ response.data เพื่อเข้าถึงข้อมูล JSON ได้สะดวกกว่า

2. การกำหนด Query Parameters
http ต้องจัดการ Query Parameters ผ่าน URL เอง
ส่วน dio สามารถกำหนดผ่าน queryParameters ได้โดยตรง

3. การจัดการ Exception
http ต้องตรวจสอบข้อผิดพลาดด้วยเงื่อนไขต่าง ๆ เอง
ส่วน dio มี DioException และ DioExceptionType สำหรับแยกประเภทข้อผิดพลาด
